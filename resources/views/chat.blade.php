...
<body>
    ...
    <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
        ...
        <!-- Input field -->
        <input type="text"
            class="flex-grow h-full px-4 ml-4 border rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
            placeholder="Type your message..." />
        <!-- Send button -->
        <button
            class="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white">
